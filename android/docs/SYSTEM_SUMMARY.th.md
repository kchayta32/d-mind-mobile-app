...
## อัปเดตสถานะล่าสุด 2026-05-28

- เพิ่มชั้นข้อมูล (Layer) การไหลของแม่น้ำ (`RiverDischarge`) และความชื้นในดิน (`SoilMoistureHeatmap`) บนหน้าแผนที่ภัยพิบัติ ดึงข้อมูลจาก Open-Meteo API (ไม่ใช้ API key) ตามจุดพิกัดในประเทศไทย
- ปรับปรุงการสลับชั้นข้อมูลใน `DisasterMapViewModel` เพื่อล้างข้อมูลและโหลดชั้นข้อมูลใหม่ได้อย่างถูกต้องตาม Lifecycle
