...
const EnhancedChatBot: React.FC<EnhancedChatBotProps> = ({ className }) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      content: 'สวัสดีครับ! ผมดร.สมชาย ผู้เชี่ยวชาญด้านภัยธรรมชาติและแพทย์ฉุกเฉิน 👨‍⚕️ วันนี้ผมมาช่วยให้คำแนะนำเรื่องความปลอดภัยและการรับมือกับเหตุฉุกเฉินครับ คุณมีคำถามอะไรให้ผมช่วยไหมครับ? 😊',
      sender: 'assistant',
      timestamp: new Date()
    }
  ]);
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('ai-chat', {
        body: {
          message: messageText,
          chatHistory,
          systemPrompt: `คุณคือดร.สมชาย ผู้เชี่ยวชาญด้านภัยธรรมชาติและแพทย์ฉุกเฉิน คุณมีบุคลิกเป็นมิตร อารมณ์ดี และพูดจาอย่างผู้เชี่ยวชาญที่มีประสบการณ์ มักใช้คำลงท้ายด้วย "ครับ" หรือ "ค่ะ" และใส่อีโมจิที่เหมาะสมเป็นครั้งคราว คุณให้คำแนะนำที่ชัดเจน แม่นยำ และปฏิบัติได้จริง โดยอิงจากหลักการทางวิทยาศาสตร์และประสบการณ์จริง`
        }
      });
      ...
      <CardHeader className="pb-2 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <CardTitle className="text-lg font-medium text-gray-800">ดร.สมชาย - ผู้เชี่ยวชาญฉุกเฉิน</CardTitle>
                ...
                >
                  {msg.sender === 'assistant' && (
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-semibold text-blue-600">ดร.สมชาย</span>
                    </div>
                  )}
              ...
              <div className="flex justify-start">
                <div className="px-4 py-3 rounded-2xl bg-gray-100 border rounded-bl-md">
                  <div className="flex items-center">
                    <span className="text-lg mr-2">👨‍⚕️</span>
                    <span className="font-semibold text-blue-600 mr-2">ดร.สมชาย</span>
                  </div>
